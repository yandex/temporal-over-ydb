module github.com/yandex/temporal-over-ydb/tests/persistencetests
...
require (
	...
	github.com/ydb-platform/ydb-go-sdk-metrics v0.17.0 // indirect
...
replace go.temporal.io/server/tests => ../../temporal/tests
